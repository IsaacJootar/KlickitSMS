          ...
          <div class="control-group" align="center">
			  ...
			  ?><a href="300pc419pxystaff.php">Back </a>
               ...
               <h4>GENERATE STAFF PAY SLIPS </h4>
                ...
                <a href="300pc419pxystaff.php" style="float:left" title="Go back to  previous page"  data-toggle="tooltip" class="btn btn-primary btn-sm"><i
                                ></i>   Back</a> <?php echo ' '. ' ' ;   ?>
                                 
                                 
                              <a class="btn btn-default" title="click here to refreash page " data-toggle="tooltip" href="f_pr_pay_slips1.php" style="float:right"><i class="glyphicon glyphicon-refresh"></i>Refresh page</a></br>
             ...
             <div class="box col-md-11">
               <div class="box-inner">
                 <div class="box-header well" data-original-title="">
                   <h2>Pay Slips Generated for <?php echo  $_SESSION['month']  . ' '.$_SESSION['year'] ; ?>                </h2>
                 ...
                 <div class="box-content">
                   ...
                   <table width="222%" class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                           ...
                           <th width="221"><?php echo "<a target='_blank' class='btn btn-primary btn-sm' href=\"f_pr_pay_slips.php?year=".(urlencode($_SESSION['year']))."&&month=".(urlencode($_SESSION['month']))."\"><i class='glyphicon glyphicon-print' ></i>  Print Pay Slip list</a>" ?>
