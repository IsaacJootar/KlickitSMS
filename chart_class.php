...
<html>
   ...
   <body>
  	<?php
     	...
     	$strQuery = "SELECT count(DISTINCT student_id) AS count, class_name FROM student_class GROUP BY class_name ORDER BY class_name ";
    ...
    <div class="box col-md-12">
        ...
        <div class="box-header well" data-original-title="">
           ...
           <a href="chat_analysis.php" title="Click here to go back " data-toggle="tooltip" class="btn btn-primary btn-sm"><i
                    ...
                    <a href="chart_class.php" title="Click here to reveal charts " data-toggle="tooltip" class="btn btn-primary btn-sm"><i
