...
if (!$fileTmpLoc) { // if file not chosen
    ...
    exit();
} else if (!preg_match("/.(jpg|pdf|docx|dotx|xls|xlsx)$/i", $fileName) ) {
...
$query="INSERT INTO `newsletter` (file_name, file_ext, file_size, `date`) VALUES ('$fileName', '$fileExt', '$fileSize', '$date') ";
$result=mysql_query($query);
	if ($result){
				$_SESSION['foto_name']= $fileName;
				$session->message("newsletter for $term has been successfully uploaded to students");
