...
<?php require_once('includes/config2.php'); ?>
		 ...
		 <div align="center">
            ...
            <div class="alert alert-info">
             ...
             <form class="form-horizontal" action="subject_to_staff2.php" method="post">
              <div align="left">
...
self.location='subject_to_staff.php?cat=' + val ;
}

</script>
<b>Select a teacher and a corresponding class to proceed</b><p><p>
<?Php
...
echo "<select name='cat'  class='form-control'  required='required' onchange=\"reload(this.form)\"><option value=''>Select Staff Name /Search Staff</option>";
...
echo "</select>";
?><a class="btn btn-default" href="subject_to_staff.php" style="float:right"><i class="glyphicon glyphicon-refresh"></i>Reset &amp; start again</a> 
              <p>&nbsp;</p>
              </div>
