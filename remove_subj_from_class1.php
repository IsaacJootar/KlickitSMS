...
<?php require_once('includes/config2.php'); ?>
		 ...
		 <div align="center">
			...
			?>
             <form class="form-horizontal" action="remove_subj_from_class.php" method="post">
              <div align="left">
...
echo "<select name='class' required ='required'  data-rel='chosen' ><option value=''>Select A Class........</option>";
