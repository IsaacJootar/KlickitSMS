...
?> 
 ...
 <div align="center"><a href="javascript:window.print()">[Fees Payments Print Out]</a></div>
 <hr>
...
<td width="240"><div align="center"><strong>Last Payment Date</strong></div></td>
   ...
   <?php  
 global $database;
 $result=$database->query("SELECT * FROM `acc_student_fees` WHERE `sess_id`='{$sess}' AND `term_id`= '{$term}'");
