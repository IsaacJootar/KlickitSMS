...
<?php require_once('classes/student_manager.php'); ?>            
            ...
            <form class="form-horizontal" action="f_create_student_exe.php" method="post">
                <fieldset>
                ...
                <div class="input-group col-md-4">
                        ...
                        <span class="input-group-addon">Admitting  Class:</span>
                        <input type="text" name="subcat"  value="<?php echo $myclass; ?>" disabled class="form-control" placeholder="First Name">
                    </div>
