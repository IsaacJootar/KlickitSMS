    ...
    <?php
      if($_POST['submit']){
        ...
        $total_exam=$_POST["total_exam"];
            ...
            $query="INSERT INTO `assessment` (`ca_num`, `section_id`, `CA1`, `CA2`, `CA3`, `CA4`, `CA5`, `score1`, `score2`, `score3`, `score4`, `score5`, `total_ca`, `total_exam` ) 
            VALUES ('{$ca_num}','{$sec_id}','{$CA1}', '{$CA2}', '{$CA3}', '{$CA4}', '{$CA5}', '{$score1}', '{$score2}', '{$score3}', '{$score4}', '{$score5}', '{$total_ca}', '{$total_exam}')" ; 
