 ...
 <div align="center"><a href="javascript:window.print()">[Student Report Print Out]</a></div>
  ...
  <tr class="transcriptheader hdsmall">
   ...
   <td><?php echo resultManager2::find_student_total_score($s_id,  $class['class_name'], $sess_id, $term_id);?></td>
    ...
    <td width="210"><div align="center"><strong>Test 1<br>10</strong></div></td>
   <td width="210"><div align="center"><strong>Test 2<br>10</strong></div></td>
 <td width="210"><div align="center"><strong>Test 3<br>10</strong></div></td>
  <td width="210"><div align="center"><strong>Test 4<br>10</strong></div></td>
