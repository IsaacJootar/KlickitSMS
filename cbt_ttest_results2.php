...
<?php require_once('classes/database.php'); ?>
 ...
 <div align="center">
        ...
        ?>    <a href="cbt_ttest_results.php"> << Back </a>
...
foreach($classes  as $class ) { 
  ...
  $student=$database->fetch_array($student);
    ...
    ?>                   
      ...
      <a href="cbt_ttest_results3.php?n=<?php echo urlencode($student['fullname'])?>&s_id=<?php echo urlencode($class['user_id'])?>&tittle_text=<?php echo urlencode($tittle_text) ?>"> View result</a> </td>
