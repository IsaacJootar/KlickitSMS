  ...
  <body>
   <!-- topbar starts -->
            ...
            <p class="center col-md-1" align="right">
                    <a href="acc_expense_analysis.php" title="Click here to reveal charts " data-toggle="tooltip" class="btn btn-primary btn-sm"><i
...
?>
 <h3 align=center style="color:#000">A total of  <?php echo  format_currency($sql['amount'])?> has been spent on <?php echo  $count ?> Items so far this term</h3>;
