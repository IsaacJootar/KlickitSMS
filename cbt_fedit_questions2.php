               ...
               ?>
                <label>
                 ...
                 <br />
                             ...
                             <?php $char++;}?>
        </p> <strong> <a href="cbt_fdelete_question.php?id=<?php echo $index;?>&tittle_text=<?php echo $tittle_text  ?>"> <i style="color:red">remove this question <?php echo $qno; ?></i> </strong>
