...
<html>
   ...
   <body>
  	<?php
     	...
     	$strQuery = "SELECT count(DISTINCT student_id) AS count, subject_name FROM student_subjects GROUP BY subject_name ORDER BY subject_name ";
     	...
     	if ($result) {
        	...
        	$arrData = array(
        	    "chart" => array(
                  "caption" => "Student and Subject analysis chart",
...
<div class="row">
    <div class="box col-md-12">
        ...
        <div class="box-header well" data-original-title="">
           ...
           <a href="chat_analysis.php" title="Click here to go back " data-toggle="tooltip" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron"></i> Back</a>
            
                    <a href="chart_subject.php" title="Click here to reveal charts " data-toggle="tooltip" class="btn btn-primary btn-sm"><i
