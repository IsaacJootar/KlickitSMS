 ...
 <div align="center">
        ...
        ?>
              ...
              <div class="alert alert-info" align="center">
               <h4>GENERATE STUDENT RESULTS (SINGLE)</h4></div>
...
self.location='generate_single_result.php?cat=' + val ;
}
...
echo "<select name='cat'  data-rel='chosen'  required='required' onchange=\"reload(this.form)\"><option value=''>Select</option>";
...
echo "<select name='subcat'  data-rel='chosen'  required='required'><option value=''>Select </option>";
             ...
             <div class="box col-md-6">
               <div class="box-inner">
                 <div class="box-header well" data-original-title="">
                   <h2>Student Results Generated                </h2>
                 ...
                 <div class="box-content">
                          ...
                          <?php echo "<a target='_blank' class='btn btn-primary btn-sm' href=\"admin_dossier_test.php?student_id=".(urlencode($_SESSION['student_id']))."&&sess_id=".(urlencode($_SESSION['sess_id']))."&&term_id=".(urlencode($_SESSION['term_id']))."\"><i class='glyphicon glyphicon-print' ></i>  Print preview filtered Result</a>" ?>
