...
<?php require_once('classes/student_manager.php'); ?>            
            ...
            <form class="form-horizontal" action="create_student_exe.php" method="post">
                <fieldset>
...
self.location='create_student.php?cat=' + val ;
}
                   ...
                   <div class="clearfix"></div><br>
                    <div class="input-group col-md-4">
                        ...
                        <select required="required" class='form-control' name="type" >
                          <option value="">Day or Boarding</option> 
                        <option value="1">Day student</option>
                        <option value="0">Boarding student</option>
                        </select>
                        </div>
                  </div>
                <div class="clearfix"></div><br>
