...
<?php
 ...
 // try and make this section selection more  dynamic-izicc//
...
{
    case 0: 
	header("location:t_ca_type0.php");
	break;
	case 2: 
	header("location:t_ca_type2.php");
	break;
	case 3: 
	header("location:t_ca_type3.php");
	break;
	case 4: 
	header("location:t_ca_type4.php");
	break;
	case 6: 
	header("location:t_ca_type6.php");
	break;
}
	?>