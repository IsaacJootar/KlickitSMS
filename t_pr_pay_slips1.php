...
<?php require_once('classes/class_manager.php'); ?>
          ...
          <div class="control-group" align="center">
			  ...
			  ?><a href="200er_b6yx9_student.php">Back </a>
               ...
               <h4>GENERATE STAFF PAY SLIPS </h4>
            </div>                 
             
                <a href="200er_b6yx9_student.php" style="float:left" title="Go back to  previous page"  data-toggle="tooltip" class="btn btn-primary btn-sm"><i
                                ></i>   Back</a> <?php echo ' '. ' ' ;   ?>
                                 
                                 
                              <a class="btn btn-default" title="click here to refreash page " data-toggle="tooltip" href="t_pr_pay_slips1.php" style="float:right"><i class="glyphicon glyphicon-refresh"></i>Refresh page</a></br>
...
if(!isset($_POST['submit'])){}?>
        <?php
    if (isset($_POST['submit'])){
	$session->message("Pay Slips for $_SESSION[month] $_SESSION[year]   has been generated successfully");
             ...
             <div class="box col-md-11">
               <div class="box-inner">
                 <div class="box-header well" data-original-title="">
                   <h2>Pay Slip Generated for <?php echo  $_SESSION['month']  . ' '.$_SESSION['year'] ; ?>                </h2>
                 ...
                 <div class="box-content">
                   ...
                   <table width="222%" class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                           ...
                           <th width="221"><?php echo "<a target='_blank' class='btn btn-primary btn-sm' href=\"t_pr_pay_slips.php?year=".(urlencode($_SESSION['year']))."&&month=".(urlencode($_SESSION['month']))."\"><i class='glyphicon glyphicon-print' ></i>  Print Pay Slip list</a>" ?>
