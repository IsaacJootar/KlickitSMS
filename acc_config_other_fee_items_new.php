...
<?php require_once('includes/config.php'); ?>
 ...
 <div align="center">
        ...
        ?> <a href="acc_manage_school_fees.php"> << back</a>
               ...
               <h4>create / Configure fees items [new students]</h4></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="box-content">
                   <form class="form-horizontal" action="acc_create_fees_items_new_exe.php" method="post">
                <fieldset>
            ...
            <div class="box-inner">
                ...
                <div class="box-content">
                   <form class="form-horizontal" action="acc_config_other_fee_items_new_exe.php" method="post">
                <fieldset>
                    <div class="input-group col-md-4">
                         ...
                         <select required ='required' name="item_name" class="form-control" id="cat">
                          <option value="">Select item</option>
                            ...
                            $query=$database->query("SELECT `id`, `item_name` 
                              FROM `acc_school_fees_items` WHERE `status`= 0 order by `id` asc");
...
?>
 ...
 <a href="#" class="btn btn-minimize btn-round btn-default"><i
  ...
  <?php
  global $database;
   $qry=$database->query("SELECT * FROM `acc_configure_school_fees_items` WHERE `status`=0 order by `id` desc " );
...
?>
         ...
         <td class="center"><?php  echo  $fees['class_name'];  ?></td>
                       <td class="center"><?php  echo  $fees['expected_to_pay'];  ?></td>
                            ...
                            <td class="center"><?php echo "<a href=\"delete_school_fees_items_new.php?id=".urlencode($fees['id'])."\"> remove item</a>" ?> </td>
