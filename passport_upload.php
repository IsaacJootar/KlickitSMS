...
$query="INSERT INTO `student_passports` (file_name, file_ext, file_size, student_id) VALUES ('$fileName', '$fileExt', '$fileSize', $s_id) ";
$result=mysql_query($query);
	if ($result){
				//$_SESSION['foto_name']= $fileName;
				$session->message("Passport has been successfully uploaded");
		redirect_to('s_update_profile.php');
		exit();
	}
		else
