...
<?php require_once('classes/database.php'); ?>
 ...
 <div align="center">
        ...
        ?>        <a href="f_cbt.php"> << Back </a>
               ...
               <h4>Manage CBT Titles / Topics</h4></div>
              <p align="center">
                ...
                <div class="box-content">
                   <form class="form-horizontal" action="cbt_fadd_tittle_exe.php" method="post">
                <fieldset>
                                              <SCRIPT language=JavaScript>
function reload(form)
{
var val=form.cat.options[form.cat.options.selectedIndex].value;
self.location='cbt_fadd_tittle.php?cat=' + val ;
}
...
echo "<select name='subcat'  class='form-control' required='required'><option value=''>Select subject </option>";
...
echo "</select>";
 ...
 ?>
                    <div  class="input-group col-md-9">
                        ...
                        <input type="text" name="tittle" required class="form-control" placeholder="Type Your title Name Here after selecting class & subjt.">
                    </div><p>
         ...
         <td class="center"><?php echo  $class['class_name'] ;  ?></td>
                       <td class="center"><?php echo  $class['subject_name'];  ?></td>
                           ...
                           <td class="center"><?php echo  $sess['session'];  ?></td>
                            ...
                            <td style="font-size:12px" class="center"> <a href="cbt_fdelete_tittle.php?id=<?php echo urlencode($class['id']) ?>"> remove </a> </td>
...
<?php
    ...
    if ($class['term'] == $term) { ?>
      <a href="cbt_fadd_questions.php?id=<?php echo urlencode($class['id']) ?>"> add questions </a> </td>
    <?php }else{
      echo "Passed term";
    }
?>
