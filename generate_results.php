            ...
            <div class="box-content row">
             ...
             <div align="center">
              ...
              <div class="alert alert-info" align="center">
               <h4>GENERATE STUDENT RESULTS BY CLASS</h4></div>
                <a href="results_stat.php" style="float:left" title="Go back to  previous page"  data-toggle="tooltip" class="btn btn-primary btn-sm"><i
                              ...
                              <a class="btn btn-default" title="click here to refreash page " data-toggle="tooltip" href="generate_results.php" style="float:right"><i class="glyphicon glyphicon-refresh"></i>Refresh page</a></br>
...
self.location='generate_results.php?cat=' + val ;
}
             ...
             <div class="box col-md-6">
               <div class="box-inner">
                 <div class="box-header well" data-original-title="">
                   <h2>Student Results Generated for <?php echo  $_POST['class_name']; ?>                </h2>
                 ...
                 <div class="box-content">
                          ...
                          <?php echo "<a target='_blank' class='btn btn-primary btn-sm' href=\"admin_dossier_test1.php?class_name=".(urlencode($_SESSION['class_name']))."&&page_count=".(urlencode($_SESSION['page_count']))."&&sess_id=".(urlencode($_SESSION['sess_id']))."&&term_id=".(urlencode($_SESSION['term_id']))."\"><i class='glyphicon glyphicon-print' ></i>  Print preview filtered Result</a>" ?>
