...
<?php require_once('classes/result_manager.php'); ?>
 ...
 <div align="center">
        ...
        ?>
            ...
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2>Click on student name to start rating</h2>
    ...
    while($student = mysql_fetch_array($result)){ ?>
         <td class="center">  <?php echo "<a href=\"f_activity_affective.php?s_id=".urlencode(($student['student_id']))."\"> {$student['fullname']}</a>" ?> </td>
  ...
  <tr>
    ...
    <th scope="row">1 - Unsatisfactory</th>
     ...
     <h6>Tick appropraitely to rate this student's  <i style="color:#000"> Affective Records.</i></h6>
                     <form method="post" action="f_activity_affective_exe.php">
                     <?php
...
<thead>
      ...
      <tbody>
  <?php 
           $result=mysql_query("SELECT * FROM `activity_affective` limit 25  ");
  ...
  <form method="post" action="f_activity.exe.php" >
                      ...
                      <?php  $index= $values['id']; ?>
                       ...
                       <?php 
              // $char='A';
               $oq=mysql_query("SELECT * FROM `activity_option_affective` limit 25");// limit number to 25 for now//?>
