          ...
          <div class="control-group" align="center">
			  ...
			  ?><a href="300pc419pxystaff.php">Back </a>
                ...
                <h4> COMPUTER BASED TEST (CBT) </h4>
                         ...
                         <p align="center">  <a href="cbt_fadd_tittle.php" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon-pencil"></i> Create Test Titles / Topics</a>
                                 
                                
                                
                                  <a href="cbt_fadd_questions.php" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon-pencil"></i>  Set Test Questions</a>
                                 <a href="cbt_fview_questions.php" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon-search"></i>  View / release Questions</a>
                                 <a href="cbt_fedit_questions.php" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon-edit"></i>  Change Questions </a><p>
                                
                                 <a href="cbt_ftest_results.php" class="btn btn-primary btn-sm"><i
