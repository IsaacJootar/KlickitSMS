            ...
            <div class="alert alert-info">
              Update Staff Account
				...
				$staff=staffManager::find_by_id($staff_id);
				 ?>
            <form class="form-horizontal" action="update_staff_exe_.php" method="post"><img src="images/avatar5.png" width="93" height="93"; style="float:right">
                <fieldset>
                 
                    <div class="input-group col-md-4">
                         <span class="input-group-addon">Firstname</span>
                        <input type="text" name="firstname"      value=" <?php echo $staff->firstname;?>"  class="form-control" placeholder="First Name">
                    </div>
                    <div class="clearfix"></div><br>

                    <div class="input-group col-md-4">
                        <span class="input-group-addon">othername</span>
                        <input type="text" name="othername"      value=" <?php echo $staff->othername;?>" class="form-control" placeholder="Other Name">
                    </div>
                <div class="clearfix"></div><br>
                     <div class="input-group col-md-4">
                        <span class="input-group-addon">Lastname</span>
                        <input type="text" name="lastname"      value=" <?php echo $staff->lastname;?>" class="form-control" placeholder="Last Name">
                    </div>
                <div class="clearfix"></div><br>
                <div class="clearfix"></div><br>
                    <div class="input-group col-md-4">
