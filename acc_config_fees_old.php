...
<?php require_once('includes/config.php'); ?>
 ...
 <div align="center">
        ...
        ?> <a href="acc_manage_school_fees.php"> << back</a>
               ...
               <h4>Configure Tuition fee for old students</h4></div>
                                   
                         <a href="acc_config_fees_new.php" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon-wrench"></i> Configure school fees for new students</a>
            ...
            <div class="box-inner">
                ...
                <div class="box-content">
                   <form class="form-horizontal" action="acc_config_fees_old_exe.php" method="post">
                <fieldset>
              ...
              <div align="left">
               <hi>Tick appropriately, the classes that will be paying this amount of school fees above</hi>
              <p>
...
?>
 ...
 <a href="#" class="btn btn-minimize btn-round btn-default"><i
  ...
  <?php
  global $database;
   $qry=$database->query("SELECT * FROM `acc_configure_tuition_fees` WHERE `status`=1 order by `id` desc " );
...
?>
         <td class="center"><?php  echo  $fees['class_name'];  ?></td>
                     ...
                     change amount
                      ...
                      <td class="center"><?php echo "<a href=\"acc_delete_tuition_fee_old.php?id=".urlencode($fees['id'])."\"> delete fee</a>" ?> </td>
...
<div class="row"><!--/span--><!--/span--><!--/span-->
  ...
  $('.openModal').click(function(){
      ...
      $.ajax({url:"edit_fees_config_dialog.php?id="+id,cache:false,success:function(result){
