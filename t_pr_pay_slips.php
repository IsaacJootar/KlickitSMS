...
<?php  
  ...
  $staff_id=$_SESSION['SESS_USER_NAME']
 ...
 <?php require_once('classes/schoolInformation.php'); ?>
  ...
  <?php
					  $year=$_GET['year'];
					    $month=$_GET['month'];
					global $database;
					 $data=$database->query("SELECT * FROM `acc_staff_monthly_payroll` WHERE `staff_id`= '$staff_id' AND `payroll_month`='$month'  AND `payroll_year` ='$year'");
					 if(!$data){
...
<tr>
    ...
    <th width="360" style="color:#600" style="font-family:'Comic Sans MS', cursive"><h1 align="center" style="color:#600"><img src="images/jet.jpg" alt="" width="83" height="83" align="left" ><?php echo $school_address=schoolInformation::find_school_name();

?> </h1>
        <p align="left">
        <h5 align="center" style="color:#600" style="font-family:'Comic Sans MS', cursive">Address: <?php echo $school_address=schoolInformation::find_school_address();?> 
...
foreach($items as $item) { ?>
         ...
         <p>Total Deductions: <?php
                    $deduct=accountsmonthlypayrollconfig::find_pr_deductions($year, $month, $staff_id);
					 echo $deduct=accountsmonthlypayrollconfig::format_currency($deduct); // format the retured currrency from gross//
					?></p>
         <p>&nbsp;</p>
         <p>&nbsp;</p>
      <p>&nbsp;</p>
...
echo $gross=accountsmonthlypayrollconfig::format_currency($gross);?>
    ...
    <td><div align="left"><strong>Net Salary:</strong>
      <?php
				   ...
				   echo $net=accountsmonthlypayrollconfig::format_currency($net); // format the retured currrency from gross//
