...
<?php require_once('includes/config2.php'); ?>
		 ...
		 <div align="center">
            ...
            <div class="alert alert-info">
             Make remark on student's result
            </div>
            
             <form class="form-horizontal" action="p_remark_exe.php" method="post">
              <div align="left">
...
self.location='p_remark.php?cat=' + val ;
}
...
echo "</select>";
?><a class="btn btn-default" href="p_remark.php" style="float:right"><i class="glyphicon glyphicon-refresh"></i>Reset &amp; start again</a> 
              <p>&nbsp;</p>
              </div>
                 
              <p class="center col-md-2" align="center">
    <button type="submit" class="btn btn-primary">Click to remark</button>
              </p> 
