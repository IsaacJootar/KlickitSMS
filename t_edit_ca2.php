 ...
 <div align="center">
			  ...
			  ?>
               ...
               <h4>Edit Score For Subject</h4></div>
                  ...
                  <p align="center">  <a href="t_edit_ca.php" class="btn btn-primary btn-sm"><i
   ...
   echo "<a href=\"t_edit_ca3.php?id=".urlencode(($values['student_id']))." &ca=".urlencode(($qry['ca_type'])). "\">Edit Score</a>" ; // collect the ca type and the student name here, and all the critaria subj, class, name, staff, id etc
   }
   else { echo "";}
   ?>
                          </td>
