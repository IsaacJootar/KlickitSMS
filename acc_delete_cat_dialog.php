...
$id = $_GET['id'];
$sql=accountExpenseCategory::find_by_id($id);
?>
 <div class="modal-header">
 
  <button type="button" class="close" data-dismiss="modal">X</button>
                   
                    <h5 style="color:#F33">Are you sure you want to delete this Category ?. </h5>
                </div>
                <div class="modal-body">
                   <form class="form-horizontal" action="acc_delete_expense_cat.php" method="post">
                <fieldset>
