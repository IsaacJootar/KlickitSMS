...
<?php require_once('classes/storeInventoryCategory.php'); ?>
 ...
 <div align="center">
			  ...
			  ?>
               ...
               <h4>Create Asset Category</h4></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 align="center">Create Inventory(asset) Category</h4>
                </div>
                <div class="modal-body">
                   <form class="form-horizontal" action="store_invent_create_cat_exe.php" method="post">
                <fieldset>
                  <div class="input-group col-md-4">
                    <div class="input-group col-md-4"> <span class="input-group-addon"> Category</i></span>
             ...
             <div class="box col-md-7">
               <div class="box-inner">
                 <div class="box-header well" data-original-title="">
                   <h2>Available Inventory (asset) Categories                  </h2>
      ...
      $category= storeInventoryCategory::find_all();
...
<div class="row"><!--/span--><!--/span--><!--/span-->
  ...
  $('.openModal').click(function(){
      ...
      $.ajax({url:"sto_invent_delete_asset_cat_dialog.php?id="+id,cache:false,success:function(result){
