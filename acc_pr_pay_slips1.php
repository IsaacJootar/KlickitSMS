...
<?php require_once('classes/database.php'); ?>
 ...
 <div align="center">
              ...
              <div class="alert alert-info" align="center">
               <h4>GENERATE STAFF PAY SLIPS</h4></div>
                <a href="acc_payroll.php" style="float:left" title="Go back to  previous page"  data-toggle="tooltip" class="btn btn-primary btn-sm"><i
                              ...
                              <a class="btn btn-default" title="click here to refreash page " data-toggle="tooltip" href="acc_pr_pay_slips1.php" style="float:right"><i class="glyphicon glyphicon-refresh"></i>Refresh page</a></br>
               ...
               <div class="box-inner">
                 ...
                 <div class="box-content">
                   ...
                   <table width="222%" class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                           ...
                           <th width="221"><?php echo "<a target='_blank' class='btn btn-primary btn-sm' href=\"acc_pr_pay_slips.php?year=".(urlencode($_SESSION['year']))."&&month=".(urlencode($_SESSION['month']))."\"><i class='glyphicon glyphicon-print' ></i>  Print filtered list</a>" ?>
