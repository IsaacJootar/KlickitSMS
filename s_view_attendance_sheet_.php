...
<div class="box-content row">
  ...
  ?>
   <?php 
  $dates=$result=$database->query("SELECT * FROM `student_attendance` WHERE `class_name`='{$class_name}' AND `student_id`='{$s_id}' AND `term_id` = '{$term_id}' AND `week`='{$week}'");
...
<p>
   ...
   <?php  
 global $database;
     $sql=$result=$database->query("SELECT * FROM `student_attendance` WHERE `class_name`='{$class_name}' AND `term_id` = '{$term_id}' AND `week`='{$week}' AND `student_id`='{$s_id}'");
