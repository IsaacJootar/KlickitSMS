...
if ($class['status'] ==0 ) { ?>
  ...
  <a href="cbt_frelease_questions1.php?tittle_text=<?php echo urlencode($class['tittle_text']) ?>"> release test </a>
</td>
    <?php }else{ ?>
      <span class='label-info label label-default'> already released </span>
   <?php } ?>
                      <td style="font-size:12px" class="center"> 
      <a href="cbt_fview_questions2.php?tittle_text=<?php echo urlencode($class['tittle_text']) ?>">view questions </a> </td>
