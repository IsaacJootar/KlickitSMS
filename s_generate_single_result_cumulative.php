        ...
        ?>
              ...
              <div class="alert alert-info" align="center">
               <h4>GENERATE STUDENT RESULT CUMULATIVE (SINGLE)</h4></div>
                <a href="100bfstudent_gpanel.php" style="float:left" title="Go back to  previous page"  data-toggle="tooltip" class="btn btn-primary btn-sm"><i
                                ></i>   Back</a> <?php echo ' '. ' ' ;   ?>
...
?>
         ...
         <td>Student Name</td> <?php
                        $quer="SELECT student_id, fullname FROM  `student_class` WHERE `student_id`='{$s_id}' ORDER BY trim(fullname) ASC"; 
             ...
             <div class="box col-md-6">
               <div class="box-inner">
                 ...
                 <div class="box-content">
                          ...
                          <?php echo "<a target='_blank' class='btn btn-primary btn-sm' href=\"s_single_result_cumulative.php?student_id=".(urlencode($_SESSION['student_id']))."&&sess_id=".(urlencode($_SESSION['sess_id']))."&&term_id=".(urlencode($term_id))."\"><i class='glyphicon glyphicon-print' ></i>  Print preview filtered Result</a>" ?>
