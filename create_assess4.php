    ...
    <?php
      if($_POST['submit']){
        ...
        $total_exam=$_POST["total_exam"];
            ...
            $query="INSERT INTO `assessment` (`ca_num`, `section_id`, `CA1`, `CA2`, `CA3`, `CA4`, `score1`, `score2`, `score3`, `score4`, `total_ca`, `total_exam` ) 
            VALUES ('{$ca_num}','{$sec_id}','{$CA1}', '{$CA2}', '{$CA3}', '{$CA4}', '{$score1}', '{$score2}', '{$score3}', '{$score4}', '{$total_ca}', '{$total_exam}')" ; 
	...
	$error_flag=false;
                 ...
                 <form action="" method="post">
                  ...
                  CA 3 Score 
                            ...
                            <p>Name of CA 
                  4
                  <input type="text" size="10" title="Enter name for 4th CA " name="CA4"  placeholder="<?php  //echo 'ca 1' ?>"/>
                  CA 4 Score 
