...
<title>Update Expense Items</title>
</head>
...
$id = $_GET['id'];
$sql=storeInventoryItems::find_by_id($id);
?>
 <div class="modal-header">
  ...
  <button type="button" class="close" data-dismiss="modal">X</button>
                ...
                <div class="modal-body">
                   <form class="form-horizontal" action="sto_invent_edit_item_exe.php" method="post">
                <fieldset>
                  <div class="input-group col-md-4">
                    <div class="input-group col-md-4"> <span class="input-group-addon">Item Name</i></span>
                      <input type="text" name="item_name" value="<?php echo $sql->item_name;?>" required class="form-control"/>
                    </div></br>
