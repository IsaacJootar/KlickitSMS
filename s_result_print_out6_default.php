 ...
 <p align="center"><a href="javascript:window.print()">[Print Out]</a></p>
  ...
  <tr class="transcriptheader hdsmall">
   ...
   <td><?php echo resultManager::find_class_lowest_average($s_id,  $class['class_name'],  $_SESSION['sess'],  $_SESSION['term']);?></td>
    ...
    <td width="100"><div align="center"><strong>CA1</strong></div></td>
   <td width="100"><div align="center"><strong>CA2</strong></div></td>
<td width="100"><div align="center"><strong>CA3</strong></div></td>
    <td width="100"><div align="center"><strong>C4</strong></div></td>
    <td width="100"><div align="center"><strong>CA5</strong></div></td>
    <td width="100"><div align="center"><strong>CA6</strong></div></td>
