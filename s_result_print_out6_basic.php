...
<?php require_once('classes/result_manager2.php'); ?>  
 ...
 <p align="center"><a href="javascript:window.print()">[Print Out]</a></p>
  ...
  <tr class="transcriptheader hdsmall">
    ...
    <td>Position:</td>
    <td><?php $query9=mysql_fetch_array(mysql_query("SELECT `pos` FROM  `score_entry_average` WHERE `student_id`='{$s_id}' AND `class_name`='{$class['class_name']}' AND `session_id`='{$_SESSION['sess']}' AND `term_id`='{$_SESSION['term']}'"));  
echo $query9['pos']; ?></td>
  </tr>
  <tr class="transcriptheader hdsmall">
   ...
   <td><?php echo resultManager::find_class_lowest_average($s_id,  $class['class_name'],  $_SESSION['sess'],  $_SESSION['term']);?></td>
    ...
    <td width="100"><div align="center"><strong>CA1<br>10</strong></div></td>
   <td width="100"><div align="center"><strong>CA2<br>10</strong></div></td>
<td width="100"><div align="center"><strong>CA3<br>10</strong></div></td>
    <td width="100"><div align="center"><strong>C4<br>10</strong></div></td>
    <td width="100"><div align="center"><strong>CA5<br>10</strong></div></td>
    <td width="100"><div align="center"><strong>CA6<br>10</strong></div></td>
   
    <td><div align="center"><strong>Exam (40%)</strong></div></td>
