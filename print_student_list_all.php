...
<p>
                 <table width="1065"  border="1" align="center" style="line-height:1">
                   <tr class="transcriptheader hdsmall"  valign="top"; style="vertical-align:top" align="center">
                     <td width="36"><div align="center"><strong>SN</strong></div></td>
                         <td width="207"><div align="center"><strong>Student's Name</strong></div></td>
    <td width="207"><div align="left"><strong>Registration No.</strong></div></td>
     <td width="207"><div align="left"><strong>Class Name</strong></div></td>
     <td width="207"><div align="left"><strong>Gender</strong></div></td>

    
  </tr>
   <?php  
 global $database;
 $name=$database->query("SELECT *  FROM `student_class` WHERE `account_status` = 1 ORDER BY trim(fullname) ASC");
 ...
 $user=$database->query("SELECT *  FROM `students`  WHERE `id`='{$exp['student_id']}' AND `account_status` = 1  ");
 if (!$name) { // add this check.
    echo('Invalid query: ' . mysql_error());
}
 ...
 <td><div align="center"><?php echo $no;?></div> </td>
  ...
  <?php $no++; ?>
   ...
   <td><div align="left"><?php echo $user;?></div> </td>
      <td><div align="left"><?php echo $exp['class_name'];?></div> </td>
        <td><div align="left"><?php echo $exp['gender'];?></div> </td>
