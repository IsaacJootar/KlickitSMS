...
<?php require_once('includes/config2.php'); ?>
 ...
 <div align="center">
        ...
        ?>
               ...
               <h4>REMOVE SUBJECT(S) FROM STUDENT(S)</h4></div>
                                  
                   <a href="remove_subject_from_student.php"> Back </a>
             <div class="box col-md-12">
               <div class="box-inner">
                 ...
                 <form action="remove_subject_from_student_exe.php" method="post">
                 <table width="250" align="left">
                   <tr>
                     <th scope="row"> 
                               <?php
                       global $database;
       $sql_students=$database->query("SELECT `student_id`, `fullname` FROM `student_class` WHERE `class_name`= '{$_SESSION['subcat']}' ORDER BY trim(fullname) ASC");
    ...
    while($values=$database->fetch_array($sql_students)){ 
                 ...
                 <h5 align="center">  Check  Appropriately to remove Subject(s) from Student(s)</h5><p>
...
?>                    
  ...
  <button style="float:center" type="submit" name="submit" value="1"   title="clicking this button will remove subject(s) to Student(s)"  data-toggle="tooltip" class="btn btn-primary">remove subject(s)</button>
          </form>               
