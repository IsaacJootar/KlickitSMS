    ...
    <div align="center">
       ...
       $query="SELECT * FROM `student_class` WHERE `class_name`='{$_SESSION['class']}' order by `fullname` ASC"; $result=mysql_query($query);
		...
		while($student = mysql_fetch_array($result)){	?>
         ...
         <td class="center"><img src="images/avatar.png" width="38" height="38"/><?php echo "<a href=\"acc_students_fees2.php?fullname={$student['fullname']}&&id=".urlencode(($student['student_id']))."\"> {$student['fullname']}</a>" ?> </td>
