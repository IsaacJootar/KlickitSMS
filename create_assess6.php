    ...
    <?php
      if($_POST['submit']){
        ...
        $total_exam=$_POST["total_exam"];
            ...
            $query="INSERT INTO `assessment` (`ca_num`, `section_id`, `CA1`, `CA2`, `CA3`, `CA4`, `CA5`, `CA6`, `score1`, `score2`, `score3`, `score4`, `score5`, `score6`, `total_ca`, `total_exam` ) 
            VALUES ('{$ca_num}','{$sec_id}','{$CA1}', '{$CA2}', '{$CA3}', '{$CA4}', '{$CA5}', '{$CA6}', '{$score1}', '{$score2}', '{$score3}', '{$score4}', '{$score5}', '{$score6}', '{$total_ca}', '{$total_exam}')" ; 
                 ...
                 <form action="" method="post">
                  <table class="table">
                     ...
                     <tbody>
                            ...
                            <p>Name of CA 
                  3
                  <input type="text" size="10" title="Enter name of 3rd CA " name="CA3"  placeholder="<?php  //echo 'ca 1' ?>"/>
                  CA 3 Score 
                                
                                 <input type="text" size="10"  title="CA score of 3rd CA" name="score3" placeholder="<?php //echo ' ca 2'?>"/> 
                            </p>
                             <p>Name of CA 
                  4
                  <input type="text" size="10" title="Enter name of 4th CA " name="CA4"  placeholder="<?php  //echo 'ca 1' ?>"/>
                  CA 4 Score 
                                
                                 <input type="text" size="10"  title="CA score of 4th CA" name="score4" placeholder="<?php //echo ' ca 2'?>"/> 
                            </p>

                            <p>Name of CA 
                  5
                  <input type="text" size="10" title="Enter name for 5th CA " name="CA5"  placeholder="<?php  //echo 'ca 1' ?>"/>
                  CA 5 Score 
                                
                                 <input type="text" size="10"  title="CA score of 5th CA" name="score5" placeholder="<?php //echo ' ca 2'?>"/> 
                            </p>
                              ...
                              <p>Name of CA 
                  6
                  <input type="text" size="10" title="Enter name for 6th CA " name="CA6"  placeholder="<?php  //echo 'ca 1' ?>"/>
                  CA 6 Score 
                                
                                 <input type="text" size="10"  title="CA score of 6th CA" name="score6" placeholder="<?php //echo ' ca 2'?>"/> 
                            </p>
							  <p>&nbsp;</p>
                              <p>                              
