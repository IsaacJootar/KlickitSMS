...
?>
    ...
    <div align="center">
			  ...
			  ?>
                 ...
                 <p align="center">  <a title="Click to go back" data-toggle="tooltip" href="acc_manage_payments.php" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon-white"></i> Back</a>
                                  <a title="Click to go back" data-toggle="tooltip" href="acc_fees_category.php" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon-white"></i> View Payments by category</a>
                                  
                                <a class="btn btn-default" title="click here to refreash page " data-toggle="tooltip" href="acc_students_fees2.php" style="float:right"><i class="glyphicon glyphicon-refresh"></i>Refresh page</a>                        
            ...
            <div class="box-inner">
                ...
                <div class="box-content">
                  <table  class="table table-striped table-bordered bootstrap-datatable datatable responsive" >
                     ...
                     <tbody>
                     <?php
                      // make these names come from school fee tables, instead of whole students in a class.//
       $query="SELECT * FROM `student_class` WHERE `class_name`='{$_SESSION['class']}' order by `fullname` ASC"; $result=mysql_query($query);
		...
		while($student = mysql_fetch_array($result)){	?>
         ...
         <td class="center"><img src="images/avatar.png" width="38" height="38"/><?php echo "<a href=\"acc_lesson_fees2.php?fullname={$student['fullname']}&&id=".urlencode(($student['student_id']))."\"> {$student['fullname']}</a>" ?> </td>
  ...
  <?php }?>
             ...
             <div class="box col-md-7">
               <div class="box-inner">
                 ...
                 <?php @$id=$_GET['id'];
				 if (isset($_GET['id'])){
				 $check=mysql_query("SELECT * FROM `acc_student_lesson` WHERE `student_id`='{$id}' AND `sess_id`='{$sess_id}' AND `term_id` = '{$term_id}' ");
				 if($check=mysql_num_rows($check) < 1){; ?>
				 
					<h4> <?php echo "No Lesson Payment details where found for this student";?></h4>
                    <?php
					 exit();
					 }
				 }
				 ...
				 $id=$_GET['id'];
				  ...
				  $_SESSION['fullname']=$_GET['fullname'];
				   $_SESSION['student_id']=$_GET['id'];
                    ...
                    $get_data=$database->query("SELECT * FROM `acc_student_lesson` WHERE `student_id`= '{$id}' AND `sess_id`='{$sess_id}' AND `term_id`= '{$term_id}'");
...
<div align="center"><strong> Payment  Status:</strong>
<?php
  if($get_data['have_paid'] >= $get_data['expected_to_pay']){
...
<hr><a data-toggle="modal" href="#myModal2" class="btn btn-primary btn-sm"><i
                               ...
                               <?php echo "<a target='_blank' class='btn btn-primary btn-sm' href=\"acc_pay_lesson_print_receipt.php?payment_id=".urlencode(($_SESSION['trans_id']))."\"><i class='glyphicon glyphicon-print'
                                ></i>  Print Reciept</a>" ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <form class="form-horizontal" action="acc_lesson_discount.php" method="post">
                <fieldset>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <form class="form-horizontal" action="acc_lesson_add_fees.php" method="post">
                <fieldset>
                   <div class="input-group col-md-4"> <span class="input-group-addon"> Lesson Fee Amount</i></span>
