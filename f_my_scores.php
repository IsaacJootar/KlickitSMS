               ...
               <h4>MY STUDENTS SCORES </h4>
                          ...
                          <a href="f_exam.php" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon-white"></i> Input scores for exams</a>
                                 ...
                                 <a href="f_veiw_result.php" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon-white"></i> Make subject comments</a>
                                 
                 <a href="f_edit_ca.php" title="Request permission from admin befor updating students scores." data-toggle="tooltip" class="btn btn-primary btn-sm"><i
            ...
            <div class="box-content">
              ...
              <div class="row ">
                    <div class="col-md-4">
                        ...
                        <form name="form" method="post" action="f_my_scores2.php">
                            <SCRIPT language=JavaScript>
function reload(form)
{
var val=form.cat.options[form.cat.options.selectedIndex].value;
self.location='f_my_scores.php?cat=' + val ;
}
