 ...
 <div class="modal-header">
  ...
  <button type="button" class="close" data-dismiss="modal">X</button>
                ...
                <div class="modal-body">
                   <form class="form-horizontal" action="acc_edit_bank_exe.php" method="post">
                <fieldset>
                  <div class="input-group col-md-4">
                    <div class="input-group col-md-4"> <span class="input-group-addon">Bank Name</i></span>
                      <input type="text" name="bank_name" value="<?php echo $sql->bank_name;?>" required class="form-control" />
                    </div></br>
                    <div class="input-group col-md-4"> <span class="input-group-addon">Bank Code</i></span>
                      <input type="text" name="bank_code" value="<?php echo $sql->bank_code;?>" required class="form-control"/>
                    </div></br>
