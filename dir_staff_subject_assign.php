...
<b>Select or search staff name</b><p>

                                            
<?Php


echo "<form method=post name='submit' action='dir_staff_subject_assign.php' >";
...
<a class="btn btn-default" href="dir_staff_subject_assign.php" style="float:right"><i class="glyphicon glyphicon-refresh"></i>Reset &amp; start again</a> 
              <p>&nbsp;</p>
              </div>
