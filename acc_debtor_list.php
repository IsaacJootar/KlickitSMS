     ...
     <div align="center">
        ...
        ?>
            ...
            <div class="alert alert-info">
              SCHOOL TUITION  DEBTOR LIST</div>
            <?php  
...
self.location='acc_debtor_list.php?cat=' + val;
}

</script>
<b><h5>Select appropriate combinations to generate list</h5></b><p><p>
<?Php
...
?>                        
        ...
        <?php echo "<a target='_blank' class='btn btn-primary btn-sm' href=\"acc_debtor_list_print.php?class_name=".(urlencode($_SESSION['class_name']))."&&s_type=".(urlencode($_SESSION['s_type']))."&&sess_id=".(urlencode($_SESSION['sess_id']))."&&term_id=".(urlencode($_SESSION['term_id']))."\"><i class='glyphicon glyphicon-print' ></i>  click to preview report</a>" ?>
