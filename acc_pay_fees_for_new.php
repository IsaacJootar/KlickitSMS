...
<?php require_once('classes/accountschoolFees.php'); ?>
 ...
 <div align="center">
			  ...
			  ?>
               ...
               <h4>CAPTURE SCHOOL FEES PAYMENTS FOR NEW STUDENTS</h4></div>
                                 
                 <a  href="acc_pay_fees.php"  title="Click here to go back to previous page " data-toggle="tooltip" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon"></i>   Back</a>
                                     <?php echo ' '. ' ' ;   ?>
            ...
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2>Make School Fees Payments</h2>

                    
                </div>
                 <form name="form" method="post" action="acc_pay_fees_for_new_exe.php">
                 
                            <SCRIPT language=JavaScript>
function reload(form)
{
var val=form.cat.options[form.cat.options.selectedIndex].value;
self.location='acc_pay_fees_for_new.php?cat=' + val ;
}
...
if(isset($cat)){
$quer="SELECT * FROM `student_class` WHERE `class_name`= '{$cat}' AND `status`= 0"; 
...
<td>
<strong></br><p>
ENTER SCHOOL FEES AMOUNT</strong></br><p>
<input type="number" name="have_paid" title="enter the school fees amount you paid" required />
 ...
 <div class="clearfix"></div>
             ...
             <div class="box col-md-7">
               <div class="box-inner">
                 <div class="box-header well" data-original-title="">
                   <h2>List of Recent Payments for new students                </h2>
                 ...
                 <div class="box-content">
                   <table width="322%" class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                     ...
                     <tbody>
                       ...
                       <?php
					  global $database;
      $payment=accountschoolFees::find_all_new($sess_id, $term_id);
foreach($payment as  $pay) { ?>
                            
        
         <?php
 $fullname=$database->query("SELECT `fullname` FROM `student_class` WHERE `student_id`= '{$pay->student_id}' AND `status`=0");
           ...
           <td class="center"><?php echo   $pay->have_paid;  ?></td>
                        ...
                        <td class="center"><?php echo $pay->trans_id ;  ?></td>
                          ...
                          <td class="center"><?php echo $pay->created_on;  ?></td>
                              <td class="center">	
                              <?php echo "<a target='_blank' class='btn btn-primary btn-sm' href=\"acc_pay_fees_print_receipt.php?payment_id=".urlencode(($pay->trans_id))."\"><i class='glyphicon glyphicon-print'
                                ></i>  Print</a>" ?>
                                </td>
