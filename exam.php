...
<?php include('classes/section_manager.php'); ?>
<?php include('classes/class_manager.php'); ?>
          ...
          <div class="control-group" align="center">
			  ...
			  ?><a href="subject_teacher.php">Back </a>
                  <?php echo $session->display_error(); ?>  
                   <div class="alert alert-info" align="center">
               <h4>Input exam scores </h4>
            </div>                 
            ...
            <div class="box-content">
              ...
              <div class="row ">
                    <div class="col-md-4">
                        ...
                        <form name="form" method="post" action="exam2.php">
                            <SCRIPT language=JavaScript>
function reload(form)
{
var val=form.cat.options[form.cat.options.selectedIndex].value;
self.location='exam.php?cat=' + val ;
}
...
///////// Getting the data from Mysql table for first list box//////////
 $quer2="SELECT * FROM `staff_class` WHERE `staff_id`='3' order by id"; 
///////////// End of query for first list box////////////

/////// for second drop down list we will check if category is selected else we will display all the subcategory///// 
if(isset($cat)){
$quer="SELECT * FROM `subject_teacher` WHERE `class_name`= '{$cat}' "; 
...
echo "</select>"; ?>
 <div class="clearfix"></div>
    ...
    <div class="box col-md-3">
       ...
       $classes = classManager::find_by_sql("SELECT * FROM `staff_class` WHERE `staff_id` = 2 order by `id` desc");
