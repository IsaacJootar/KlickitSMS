...
<?php require_once('classes/staff_manager.php'); ?>            
            <div class="box-content row">
			  ...
			  ?>
                  ...
                  <p class="center col-md-1" align="right">
                    <a href="700jstpxvzpdo_accts.php">Back</a>
                    </p> 
            ...
            <form class="form-horizontal" action="acc_create_staff_exe.php" method="post"><img src="images/avatar5.png" width="93" height="93"; style="float:right">
                <fieldset>
                ...
                <div class="clearfix"></div><br>
                    ...
                    <div class="clearfix"></div><br>
                     <div class="input-group col-md-4">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" name="user_id" required class="form-control" placeholder="Staff id no.">
                    </div>
                <div class="clearfix"></div><br>
                    <div class="input-group col-md-4">
...
<?php } ?>
            ...
            <option value="Zimbabwe">Zimbabwe</option>
                ...
                <div class="clearfix"></div><br>
                    <div class="input-group col-md-4">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" name="num_of_kin" class="form-control" placeholder="Phone Number of Kin">
                    </div>
                <div class="clearfix"></div><br>
					<div class="input-group col-md-4">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user red"></i></span>
                        <input type="text" name="status" class="form-control" placeholder="Marriage Status">
                    </div>
                <div class="clearfix"></div><br>
                    
                    <div class="input-prepend">
                        <label class=""> <a href="signup.php">Click here to create new account</a></label>
                    </div>
