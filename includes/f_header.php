...
$dp=$dp['fullname'];
 ...
 $myclass=$database->query("SELECT * FROM `form_master` WHERE staff_id= '{$id}' ");
if(!$result){echo "error". mysql_error();}
$myclass=$database->fetch_array($myclass);
                  ...
                  <ul class="nav nav-pills nav-stacked main-menu">
                    <li><a class="ajax-link" href="300pc419pxystaff.php"><i class="glyphicon glyphicon-home"></i><span> Home</span></a>
                        ...
                        <li><a class="ajax-link" href="f_exam.php"><i class="glyphicon glyphicon-edit"></i><span> Enter exam scores</span></a>
                         ...
                         <li><a class="ajax-link" href="f_my_students.php"><i class="glyphicon glyphicon-user"></i><span> My Students list</span></a>
                         <li> <a href="f_cbt.php"><i class="glyphicon glyphicon-phone"></i><span>  Computer Based Test</span></a>
                        </li> <li><a class="ajax-link" href="f_activity.php"><i class="glyphicon glyphicon-ok"></i><span> Activity ratings</span></a>
                        ...
                        <li><a class="ajax-link" href="view_homework.php"><i class="glyphicon glyphicon-ok"></i><span> View/grade Assignment</span></a>
                          <li><a class="ajax-link" href="f_attendance1.php"><i class="glyphicon glyphicon-edit"></i><span> Attedance</span></a>
