...
<?php require_once('classes/accountExpense.php'); ?>
 ...
 <div align="center">
			  ...
			  ?>
               ...
               <h4>UPDATE EXPENSES</h4></div>
                 ...
                 <a href="acc_expense.php" title="Click here to go back to main page " data-toggle="tooltip" class="btn btn-primary btn-sm"><i
                                ...
                                <a class="btn btn-default" title="click here to refreash page " data-toggle="tooltip" href="acc_edit_expense.php" style="float:right"><i class="glyphicon glyphicon-refresh"></i>Refresh page</a>                        
                        <p align="center"></br>
      ...
      $category = accountExpense::find_all($sess_id, $term_id);
foreach($category as $cat) { ?>
                       
         <td class="center"><?php echo strtoupper( $cat->cat_name);  ?></td>
                       <td class="center"><?php echo  $cat->item_name ;  ?></td>
                        <td class="center"><?php echo  $cat->amount ;  ?></td>
                        <td class="center"><?php echo  $cat->approved_by ;  ?></td>
...
<div class="row"><!--/span--><!--/span--><!--/span-->
  ...
  $('.openModal').click(function(){
      ...
      $.ajax({url:"acc_edit_expense_dialog.php?id="+id,cache:false,success:function(result){
