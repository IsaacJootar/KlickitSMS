 ...
 <div align="center">
  ...
  $error_flag=false;
         ...
         ?>
                 ...
                 <form action="f_ca_type5_exe.php" method="post">
                  <table class="table">
                     <thead>
...
<input type="number" <?php if($database->num_rows($check_status)== 1){echo 'disabled';
    ...
    <input type="number" <?php if($database->num_rows($check_status)== 1){echo 'disabled';
    }?> size="8" min="0" max="<?php echo $config['score6'] ?>" step=0.01  title="<?php echo $config['CA6']. 'cannot be more than'.  $config['score6']; ?> " name="<?php echo $values['student_id'].'ca6';?>" placeholder="<?php echo  $config['CA6']; ?>" value="<?php echo $qry['CA6'];?>" />  
