...
<td width="350"><div align="center"><?php echo $ca_name['CA5'];?><br>(<?php echo $ca_name['score5'];?> marks)</div></td>
<td width="350"><div align="center"><?php echo $ca_name['CA6'];?><br>(<?php echo $ca_name['score6'];?> marks)</div></td>
