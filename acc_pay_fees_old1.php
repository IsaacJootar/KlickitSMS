...
<?php require_once('classes/database.php'); ?>
		 ...
		 <div align="center">
            ...
            <div class="alert alert-info">
              SCHOOL FEES PAYMENT FOR OLD STUDENTS</div>
            <?php  
						  
			?>
             <form class="form-horizontal" action="acc_pay_fees_old2.php" name="class_name" method="post">
               <SCRIPT language=JavaScript>
function reload(form)
{
var val=form.cat.options[form.cat.options.selectedIndex].value;
self.location='acc_pay_fees_old1.php?cat=' + val ;
}
