          ...
          <div class="control-group" align="center">
			  ...
			  ?><a href="200er_b6yx9_student.php">Back </a>
                ...
                <h4> INPUT ASSESSMENT SCORES </h4>
                          ...
                          <a href="t_exam.php" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon-white"></i> Input scores for exams</a>
                                 
                                
                 <a href="t_edit_ca.php" title="Request permission from admin befor updating students scores." data-toggle="tooltip" class="btn btn-primary btn-sm"><i
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
              ...
              <div class="row ">
                        ...
                        <form name="form" method="post" action="t_check_section_ca.php">
                            <SCRIPT language=JavaScript>
function reload(form)
{
var val=form.cat.options[form.cat.options.selectedIndex].value;
self.location='t_ca.php?cat=' + val ;
}
