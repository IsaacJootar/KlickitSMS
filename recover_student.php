 ...
 <div align="center">
            ...
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2>Click to reveal student login details</h2>

                    
                </div>
                <div class="box-content">
                  <form method="post" action="recover_student.php" >
       ...
       $names = mysql_query("SELECT fullname, username, password FROM `students` WHERE `account_status` = 1 ORDER BY trim(fullname) ASC ");
