...
?>
 ...
 <div class="modal-header">
  ...
  <button type="button" onclick="window.location.href = 'acc_pay_fees_old2.php';" class="close" data-dismiss="modal">close</button>
                   
                    <h4 align="center">Make changes for:<b style="color:#000"> <?php echo ucwords($data['fullname']);?></b> </h4>
                 
                </div>
                <div class="modal-body" align="center">
                   <form class="form-horizontal" action="acc_pay_fees_edit_old_exe.php" method="post">
...
<?php
                  while($configs=$database->fetch_array($query2)) { ?>
                    ...
                    <div class="input-group col-md-4"> <span class="input-group-addon"><?php echo  $configs['item_name']; ?> [₦]</span>
                      <input type="text" name="other_items[<?php echo $configs['item_name'] ?>]"  value="<?php echo $configs['have_paid']; ?>" placeholder="enter amount" class="form-control"/>
                    </div></br>
                 <?php  } ?>
