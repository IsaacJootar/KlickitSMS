...
<?php require_once('classes/accountBudgetCategory.php'); ?>
...
<div class="row">
 ...
 <div align="center">
			  ...
			  ?>
               ...
               <h4>View Budget Category</h4></div>
                 ...
                 <a href="900_dir_encode_qpde_md765ahd098265.php" title="Click here to go back to main page " data-toggle="tooltip" class="btn btn-primary btn-sm"><i
                                ...
                                <a class="btn btn-default" title="click here to refreash page " data-toggle="tooltip" href="dir_budget_cat.php" style="float:right"><i class="glyphicon glyphicon-refresh"></i>Refresh page</a>                        
                        <p align="center"></br>
      ...
      $category = accountBudgetCategory::find_all();
foreach($category as $cat) { ?>
                       
         <td class="center"><?php echo  $cat->cat_name ;  ?></td>
                       <td class="center"><?php echo  $cat->cat_code ;  ?></td>
