	...
	$error_flag=false;
	 // get dossier config//
         ...
         ?>
                 ...
                 <form action="vet_type3_exe.php" method="post">
                  <table class="table">
                     <thead>
	  ...
	  while($values=mysql_fetch_array($sql)){	
        ...
        ?>
							  ...
							  <label>
									...
									<td>   <input type="number"   size="8" min="0" max="<?php echo $config['score1'] ?>"  title="<?php echo $config['CA1']. 'cannot be more than'.  $config['score1']; ?> " name="<?php echo $values['student_id'].'ca1' ;?>" placeholder="<?php echo  $config['CA1']; ?>"   value="<?php echo $qry['CA1'];?>" /> 
                                         </td>
									  <td>
									  <input type="number"   size="8" min="0" max="<?php echo $config['score2'] ?>"  title="<?php echo $config['CA2']. 'cannot be more than'.  $config['score2']; ?> " name="<?php echo $values['student_id'].'ca2' ;?>" placeholder="<?php echo  $config['CA2']; ?>"   value="<?php echo $qry['CA2'];?>" /> 
                                         </td>
                                         <td>
									 <input type="number"   size="8" min="0" max="<?php echo $config['score3'] ?>"  title="<?php echo $config['CA3']. 'cannot be more than'.  $config['score3']; ?> " name="<?php echo $values['student_id'].'ca3' ;?>" placeholder="<?php echo  $config['CA3']; ?>"   value="<?php echo $qry['CA3'];?>" />   </td>
                                     
                                     <td style="font-weight:bold"> 
                                     <?php echo $qry['CA_total'];?>  </td>
                                      <td>
                                       <input type="text" size="1" name="<?php echo $values['student_id'].'exam';?>"   value="<?php echo $qry['exam'];?>" />  </td>
                                       
                                     <td style="font-weight:bold"> 
                                       <?php echo $qry['term_total'];?>  </td>
                                      <td style="font-weight:bold"> 
                                         <?php echo $qry['grade'];?> </td>
                                       
                                        
                                        <?php if ($qry['term_total'] >=70 and $qry['term_total']<=100 ){
											 ?>
                                               <td>
                                       <span class='label-success'><?php echo $qry['remark']; }?> </span>
                                      </td>
                                       
                                       <?php if ($qry['term_total'] >=60 and $qry['term_total']<=69 ){
											 ?>
                                               <td>
                                       <span class='label-info'><?php echo $qry['remark']; }?> </span>
                                      </td>
                                       
                                       <?php if ($qry['term_total'] >=50 and $qry['term_total']<=59 ){
											 ?>
                                               <td>
                                       <span class='label-primary'><?php echo $qry['remark']; }?> </span>
                                      </td>
                                       <?php if ($qry['term_total'] >=40 and $qry['term_total']<=49 ){
											 ?>
                                               <td>
                                       <span class='label-warning'><?php echo $qry['remark']; }?> </span>
                                      </td>
                                       
                                        <?php if ($qry['term_total'] >=30 and $qry['term_total']<=39 ){
											 ?>
                                               <td>
                                       <span class='label-danger'><?php echo $qry['remark']; }?> </span>
                                      </td>
                                        <?php if ($qry['term_total']<29 ){
											 ?>
                                               <td>
                                       <span class='label-danger'><?php echo $qry['remark']; }?> </span>
                                      </td>
