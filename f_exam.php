...
<?php require_once('classes/class_manager.php'); ?>
          ...
          <div class="control-group" align="center">
			  ...
			  ?><a href="300pc419pxystaff.php">Back </a>
               ...
               <h4>INPUT EXAMINATION SCORES </h4>
            </div>                 
                       
                           <a href="f_ca.php" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon-white"></i> Input scores for all CAs</a>
                                 
                                 
                               
                <a href="#" title="Request permission from admin befor updating students scores." data-toggle="tooltip" class="btn btn-primary btn-sm"><i
                                class="glyphicon glyphicon-chevron glyphicon-white"></i> Update students scores</a>   
                              
                                 <a class="btn btn-default" href="f_exam.php" style="float:right"><i class="glyphicon glyphicon-refresh"></i>Refresh page</a>        
            ...
            <div class="box-content">
              ...
              <div class="row ">
                    <div class="col-md-4">
                        ...
                        <form name="form" method="post" action="check_section_exam.php">
                            <SCRIPT language=JavaScript>
function reload(form)
{
var val=form.cat.options[form.cat.options.selectedIndex].value;
self.location='f_exam.php?cat=' + val ;
}
...
echo "<select name='cat'   class='form-control' required='required' onchange=\"reload(this.form)\"><option value=''>Select a class /Search class.....</option>";
